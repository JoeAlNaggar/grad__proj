...
export default function ContentEditor() {
  ...
  return (
    <div className="relative">
      <Button variant="outline" className="rounded-full w-12 h-12" onClick={() => setShowList(!showList)}>
        <Plus className="w-6 h-6" />
      </Button>
      {showList && (
        <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 backdrop-filter backdrop-blur-lg bg-opacity-75 dark:bg-opacity-75 z-50">
